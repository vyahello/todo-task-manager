...
function run_pydocstyle_analysis() {
    echo "Running pydocstyle analysis ..." && ( pydocstyle --explain --count ${PY_FILES} ${PROJECT_FILES} )
}
...
function run_code_analysis {
    ...
    run_pydocstyle_analysis || store_failures "pydocstyle analysis is failed!"
